...
class costants:
    def __init__(self):
        input("\nLa mayor parte de este programa esta basado en el codigo de Rafael Gonzalez-Gouveia." \
            + " Mi aportacion se limita a escribirlo con clases, realizar el grafico de barras, " \
            + "que pueda ser jugado a traves de la terminal y agregar la opcion de seleccionar al jugador inicial.\n\n" \
            + "Irving Gomez-Mendez\n\n\n"
        )
